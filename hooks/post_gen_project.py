...
def remove_sass_files():
    shutil.rmtree(os.path.join("base", "static", "sass"))
...
def remove_celery_files():
    file_names = [
        ...
        os.path.join("apps", "users", "tasks.py"),
        os.path.join(
...
def remove_drf_starter_files():
    ...
    shutil.rmtree(os.path.join("apps", "users", "api"))
    os.remove(
        os.path.join(
            "apps", "users", "tests", "test_drf_urls.py"
        )
    )
    os.remove(
        os.path.join(
            "apps", "users", "tests", "test_drf_views.py"
        )
    )
    os.remove(
        os.path.join(
            "apps", "users", "tests", "test_swagger.py"
        )
    )


def remove_storages_module():
    os.remove(os.path.join("base", "utils", "storages.py"))
