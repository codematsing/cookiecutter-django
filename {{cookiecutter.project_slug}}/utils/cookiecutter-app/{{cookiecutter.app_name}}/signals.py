...
# @receiver(post_save, sender={{cookiecutter.camel_case_model_name}})
...
# @receiver(pre_delete, sender={{cookiecutter.camel_case_model_name}})
...
# @receiver(m2m_changed, sender={{cookiecutter.camel_case_model_name}}.<model_fk>.through)
